# Contributing to fix-orchestra

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fix-orchestra. These guidelines are not strict rules.
...
The fix-orchestra team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fix-orchestra technical leads
...
[issues]: https://github.com/lmodel/fix-orchestra/issues/
[pulls]: https://github.com/lmodel/fix-orchestra/pulls/
